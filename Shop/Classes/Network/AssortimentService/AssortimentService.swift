...
final class AssortimentService {
    ...
    let items: [ProductModel] = [
        ProductModel.init(image: [ProductImageModel.init(image: #imageLiteral(resourceName: "shorts"))], name: "Жопа", price: "3500", article: "Артикул: W4/1-08324-40-(XS)", color: [ColorModel.init(color: UIColor.blue)], size: [SizeModel.init(size: "42(S)")], category: .new),
