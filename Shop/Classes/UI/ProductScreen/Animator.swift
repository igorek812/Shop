...
//  Shop
//
//  Created by Евгений Прохоров on 08.08.2021.
//
...
final class Animator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    private let firstViewController: ProduitViewController
    private let secondViewController: ProductImageViewController
    private var selectedCellImageViewSnapshot: UIView
    private let cellImageViewRect: CGRect
    
    init?(type: PresentationType, firstViewController: ProduitViewController, secondViewController: ProductImageViewController, selectedCellImageViewSnapshot: UIView) {
        self.type = type
        ...
        guard let window = firstViewController.view.window ?? secondViewController.view.window,
              let selectedCell = firstViewController.productCollectionViewManager?.selectedCell
        else { return nil }
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        guard let selectedCell = firstViewController.productCollectionViewManager?.selectedCell,
